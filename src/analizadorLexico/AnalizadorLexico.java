...
public class AnalizadorLexico {
    ...
    public AnalizadorLexico(String archivo) {
        ...
        /***** MATRIZ DE ACCIONES SEMÁNTICAS *****/
                ...
                /*4*/    this.matrizAccionesSemanticas.set(4,0,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,1,accionSemantica2) ; this.matrizAccionesSemanticas.set(4,2,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,3,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,4,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,5,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,6,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,7,accionSemantica8)  ; this.matrizAccionesSemanticas.set(4,8,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,9,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,10,accionSemantica2) ; this.matrizAccionesSemanticas.set(4,11,accionSemantica2) ; this.matrizAccionesSemanticas.set(4,12,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,13,accionSemantica8)  ; this.matrizAccionesSemanticas.set(4,14,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,15,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,16,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,17,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,18,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,19,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,20,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,21,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,22,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,23,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,24,accionSemantica8) ; this.matrizAccionesSemanticas.set(4,25,accionSemantica8);
